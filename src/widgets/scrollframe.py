...
class ScrollFrame (ttkbootstrap.Frame):
    def __init__(self, master, horizontal_scroller: Optional[bool] = None, vertical_scroller: Optional[bool] = None,
    ...
    def sbin_event_variety(self, _: tkinter.Event):
        """## 控件变动事件"""
    ...
    def bin_child_widgets_bind(self, widget: Optional[tkinter.Widget] = None, recursion: bool = True):
        """为控件的子控件绑定滚动事件"""
